    ...
    >
        <div className='flex flex-col space-y-2'>
            ...
            <input
                ...
                className='form-style w-full rounded-sm p-1'
            />
            {
                errors.courseTitle && (
        ...
        <div className='flex flex-col space-y-2'>
            ...
            <textarea
                ...
                className='form-style resize-x-none min-h-[130px] w-full rounded-sm p-1'
                />
            {
        ...
        <div className='relative flex flex-col space-y-2'>
            ...
            <input
                ...
                className='form-style w-full !pl-12 rounded-sm p-1'
            />
            <HiOutlineCurrencyRupee size={30}  className='absolute top-5 text-richblack-400'/>
            {
                errors.coursePrice && (
        ...
        <div className='flex flex-col space-y-2'>
            ...
            <select disabled={editCourse} className='form-style w-full rounded-sm p-1'
            id='courseCategory'
            defaultValue=""
